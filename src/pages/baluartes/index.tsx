...
export default function Baluartes() {
  return(
    <Flex direction="column" align="center" justify="center">
      ...
      <Flex direction="column" my="2rem" mt="8rem" w={{ base:"90%", lg:"82.5rem"}} align="center" justify="center" >
        <Flex direction="column" p={{ base:"2rem", lg:"3rem"}} mb="2rem" align="center" justify="center" borderRadius="10" bgColor="#000" color="#FFC632" >
          <Heading as={Text} fontWeight={{ base:"800", lg:"bold"}} textAlign="center" fontSize={{ base:"2rem", lg:"3rem" }}>
            NOSSOS BALUARTES
          </Heading>
          <Text as="cite" w={{ base:"85%", lg:"50%"}} textAlign="center" color="#f8f9f9" fontWeight="500" fontSize={{ base:"0.9688rem", lg:"1.125rem"}} lineHeight="1.5rem" >
        ...
        <Flex my={{ base:"1rem", lg:"3rem"}} borderRadius="10" direction="column" align="center" >
          <Flex align="center" justify="center">
            <Wrap justify="center" spacing={{ base:"none", lg:"8rem"}} >
              <WrapItem>
                <Flex boxSize={{ base:"none", lg:"450px"}} direction="column" mb={{ base: "3rem", lg:"none"}} >
                  <Image w={{ base:"25rem", lg:"28.125rem"}} h="250px" objectFit="cover" src="https://bit.ly/auxiliumchristianorum" borderRadius="10" mb="2" />
                  <Flex w={{ base:"25rem", lg:"28.125rem"}} direction="column" align="center" justify="center" >
              ...
              <WrapItem>
                <Flex boxSize={{ base:"none", lg:"450px"}} direction="column" mb={{ base: "3rem", lg:"none"}} >
                  <Image w={{ base:"25rem", lg:"28.125rem"}} h="250px" objectFit="cover" src="https://bit.ly/ignatiusantioquia" borderRadius="10" mb="2" />
                  <Flex w={{ base:"25rem", lg:"28.125rem"}} direction="column" align="center" justify="center">
                    <Heading as={Text} fontSize="1.5rem" align="center" >
              ...
              <WrapItem>
                <Flex boxSize={{ base:"none", lg:"450px"}} direction="column" align="center" justify="center" mb={{ base: "3rem", lg:"none"}}>
                  <Image h="250px" w={{ base:"25rem", lg:"28.125rem"}} objectFit="cover" src="https://bit.ly/ThomasAquina" borderRadius="10" mb="2" />
                  <Flex w={{ base:"25rem", lg:"28.125rem"}} direction="column" align="center" justify="center">
                    <Heading as={Text} fontSize="1.5rem" align="center" >
              ...
              <WrapItem> 
                <Flex boxSize={{ base:"none", lg:"450px"}} direction="column" align="center" justify="center" mb={{ base: "3rem", lg:"none"}}>
                  <Image w={{ base:"25rem", lg:"28.125rem"}} h="250px" objectFit="cover" src="https://bit.ly/AugustineHipo" borderRadius="10" mb="2" />
                  <Flex w={{ base:"25rem", lg:"28.125rem"}} direction="column" align="center" justify="center">
                    <Heading as={Text} fontSize="1.5rem" align="center" >
              ...
              <WrapItem>
                <Flex boxSize={{ base:"none", lg:"450px"}} direction="column" align="center" justify="center" mb={{ base: "3rem", lg:"none"}} >
                  <Image h="250px" w={{ base:"25rem", lg:"28.125rem"}} objectFit="cover" src="https://bit.ly/StAntao" borderRadius="10" mb="2" />
                  <Flex w={{ base:"25rem", lg:"28.125rem"}} direction="column" align="center" justify="center">
                    <Heading as={Text} fontSize="1.5rem" align="center" >
                      Santo Antão
                    </Heading>
              ...
              <WrapItem>
                <Flex boxSize={{ base:"none", lg:"450px"}} direction="column" align="center" justify="center" mb={{ base: "3rem", lg:"none"}} >
                  <Image h="250px" w={{ base:"25rem", lg:"28.125rem"}} objectFit="cover" src="https://bit.ly/Theresee" borderRadius="10" mb="2" />
                  <Flex w={{ base:"25rem", lg:"28.125rem"}} direction="column" align="center" justify="center">
                    <Heading as={Text} fontSize="1.5rem" align="center" >
